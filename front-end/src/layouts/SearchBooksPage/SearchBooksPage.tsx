...
export const SearchBooksPage = () => {
    ...
    const fetchBooks = async () => {
      ...
      for (const key in responseData) {
        loadedBooks.push({
          ...
          copiesAvailabel: responseData[key].copiesAvailabel,
  ...
  const indexOfFirstBook: number = (currentPage - 1) * booksPerPage;
  let lastItem =
          ...
          <div className="row mt-5">
            ...
            <div className="col-4">
              <div className="dropdown">
                ...
                >
                  <li onClick={() => categoryChange("All")}>
                    <a className="dropdown-item" href="#">
                      All
                    </a>
                  </li>
                  <li onClick={() => categoryChange("FE")}>
                    <a className="dropdown-item" href="#">
                      Front-End
                    </a>
                  </li>
                  <li  onClick={() => categoryChange("BE")}>
                    <a className="dropdown-item" href="#">
                      Back-End
                    </a>
                  </li>
                  <li onClick={() => categoryChange("DATA")}>
                    <a className="dropdown-item" href="#">
                      Data
                    </a>
                  </li>
                  <li onClick={() => categoryChange("DEVOPS")}>
                    <a className="dropdown-item" href="#">
                      DevOps
                    </a>
                  </li>
